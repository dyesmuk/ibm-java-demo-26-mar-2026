...
- [1. Introduction to Java and OOP](#1-introduction-to-java-and-oop)
- [2. Software Installation and First Java Program](#2-software-installation-and-first-java-program)
- [3. Static Members and Their Execution Control Flow](#3-static-members-and-their-execution-control-flow)
- [4. Non-Static Members and Their Execution Control Flow](#4-non-static-members-and-their-execution-control-flow)
- [5. Datatypes, Literals, Variables, Type Conversion, Casting & Promotion](#5-datatypes-literals-variables-type-conversion-casting-promotion)
- [6. Wrapper Classes with Autoboxing & Unboxing](#6-wrapper-classes-with-autoboxing-unboxing)
- [7. Operators and Assignments](#7-operators-and-assignments)
- [8. Flow Control Statements](#8-flow-control-statements)
- [9. Access Modifiers](#9-access-modifiers)
- [10. Packages](#10-packages)
- [11. Event Management Usecase](#11-event-management-usecase)
...
- [16. Exception Handling and Assertions](#16-exception-handling-and-assertions)
- [17. Multithreading](#17-multithreading)
- [1. Extending Thread class](#1-extending-thread-class)
- [2. Implementing Runnable (preferred)](#2-implementing-runnable-preferred)
- [18. Executor Framework Quick Start](#18-executor-framework-quick-start)
- [19. Garbage Collection & Types of Objects](#19-garbage-collection-types-of-objects)
- [20. Inner Classes](#20-inner-classes)
- [1. Non-static (Regular) Inner Class](#1-non-static-regular-inner-class)
- [2. Static Nested Class](#2-static-nested-class)
- [3. Local Inner Class](#3-local-inner-class)
- [4. Anonymous Inner Class](#4-anonymous-inner-class)
- [21. String Handling](#21-string-handling)
- [22. IO Streams (File IO)](#22-io-streams-file-io)
- [23. Arrays](#23-arrays)
- [24. Object Class Methods](#24-object-class-methods)
- [25. Collections with Generics](#25-collections-with-generics)
- [26. Enums](#26-enums)
- [27. Java 8 Features](#27-java-8-features)
- [28. JVM Architecture](#28-jvm-architecture)
- [1. ClassLoader](#1-classloader)
- [2. Runtime Data Areas (Memory)](#2-runtime-data-areas-memory)
- [3. Execution Engine](#3-execution-engine)
- [29. Java Annotations](#29-java-annotations)
- [30. Core Java - Interview Questions](#30-core-java-interview-questions)
- [31. HTTP Client API (Java 11+)](#31-http-client-api-java-11)
- [32. Java 13 and 14 Features](#32-java-13-and-14-features)
...
## 3. Static Members and Their Execution Control Flow
...
## 4. Non-Static Members and Their Execution Control Flow
...
## 5. Datatypes, Literals, Variables, Type Conversion, Casting & Promotion
...
## 6. Wrapper Classes with Autoboxing & Unboxing
...
## 16. Exception Handling and Assertions
...
## 18. Executor Framework Quick Start
...
## 19. Garbage Collection & Types of Objects
